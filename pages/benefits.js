            ...
            <div className="row center-xs">
              <div className="col-xs-10">
                <div className="start-xs">
                  ...
                  <h3>{t('benefits:body.benefit1', { defaultValue: '1. Eliminate chargeback fraud' })}</h3>
                  <p>
                  ...
                  <h3>{t('benefits:body.benefit2', { defaultValue: '2. Transaction speed and immediate availability' })}</h3>
                  <p>
                  ...
                  <h3>{t('benefits:body.benefit3', { defaultValue: '3. Lower transaction costs' })}</h3>
                  <p>
                  ...
                  <h3>{t('benefits:body.benefit4', { defaultValue: '4. Wraith Protocol' })}</h3>
                  <p>
                  ...
                  <h3>{t('benefits:body.benefit5', { defaultValue: '5. Attract new customers' })}</h3>
                  <p>
                  ...
                  <h3>{t('benefits:body.benefit6', { defaultValue: '6. Garner publicity' })}</h3>
                  <p>
                  ...
                  <h3>{t('benefits:body.benefit7', { defaultValue: '7. Buy into an inevitable business practice' })}</h3>
                  <p>
                  ...
                  <h3>{t('benefits:body.benefit8', { defaultValue: '8. Gain experience with blockchain technology' })}</h3>
                  <p>
