        ...
        <Content>
          <div className="row">
            ...
            <ul>
              ...
              <div className="pool-item"><Link href="http://zergpool.com/site/mining?algo=scrypt"><a href="http://zergpool.com/site/mining?algo=scrypt" target="_blank" rel="noopener noreferrer">ZergPool</a></Link></div>
              <h2>Myr-Groestl</h2>
              <div className="pool-item"><Link href="https://bsod.pw/en/pool/dashboard/xvg/"><a href="https://bsod.pw/en/pool/dashboard/xvg/" target="_blank" rel="noopener noreferrer">BSOD.PW</a></Link></div>
              ...
              <div className="pool-item"><Link href="https://www.f2pool.com/"><a href="https://www.f2pool.com/" target="_blank" rel="noopener noreferrer">F2Pool</a></Link></div>
              <div className="pool-item"><Link href="http://zergpool.com/site/mining?algo=myr-gr"><a href="http://zergpool.com/site/mining?algo=myr-gr" target="_blank" rel="noopener noreferrer">ZergPool</a></Link></div>
              <h2>Lyra2Rev2</h2>
              <div className="pool-item"><Link href="https://bsod.pw/en/pool/dashboard/xvg/"><a href="https://bsod.pw/en/pool/dashboard/xvg/" target="_blank" rel="noopener noreferrer">BSOD.PW</a></Link></div>
              <div className="pool-item"><Link href="http://blockmasters.co/"><a href="http://blockmasters.co/" target="_blank" rel="noopener noreferrer">Block Masters </a></Link></div>
              <div className="pool-item"><Link href="http://poolovich.pro/"><a href="http://poolovich.pro/" target="_blank" rel="noopener noreferrer">Poolovich </a></Link></div>
              ...
              <div className="pool-item"><Link href="https://www.f2pool.com/"><a href="https://www.f2pool.com/" target="_blank" rel="noopener noreferrer">F2Pool</a></Link></div>
              <div className="pool-item"><Link href="http://zergpool.com/site/mining?algo=lyra2v2"><a href="http://zergpool.com/site/mining?algo=lyra2v2" target="_blank" rel="noopener noreferrer">ZergPool</a></Link></div>
              <h2>Blake2s</h2>
              <div className="pool-item"><Link href="http://www.zpool.ca/site/mining"><a href="http://www.zpool.ca/site/mining" target="_blank" rel="noopener noreferrer">ZPool</a></Link></div>
              ...
              <div className="pool-item"><Link href="https://www.mining-dutch.nl"><a href="https://www.mining-dutch.nl" target="_blank" rel="noopener noreferrer">mining-dutch.nl</a></Link></div>
              <div className="pool-item"><Link href="https://www.f2pool.com/"><a href="https://www.f2pool.com/" target="_blank" rel="noopener noreferrer">F2Pool</a></Link></div>
              <div className="pool-item"><Link href="http://zergpool.com/site/mining?algo=blake2s"><a href="http://zergpool.com/site/mining?algo=blake2s" target="_blank" rel="noopener noreferrer">ZergPool</a></Link></div>
              <h2>x17</h2>
              <div className="pool-item"><Link href="https://bsod.pw/en/pool/dashboard/xvg/"><a href="https://bsod.pw/en/pool/dashboard/xvg/" target="_blank" rel="noopener noreferrer">BSOD.PW</a></Link></div>
              <div className="pool-item"><Link href="http://blockmasters.co/"><a href="http://blockmasters.co/" target="_blank" rel="noopener noreferrer">Block Masters </a></Link></div>
              <div className="pool-item"><Link href="https://hashfaster.com/"><a href="https://hashfaster.com/" target="_blank" rel="noopener noreferrer">HashFaster </a></Link></div>
              ...
              <div className="pool-item"><Link href="https://www.f2pool.com/"><a href="https://www.f2pool.com/" target="_blank" rel="noopener noreferrer">F2Pool</a></Link></div>
              <div className="pool-item"><Link href="http://zergpool.com/site/mining?algo=x17"><a href="http://zergpool.com/site/mining?algo=x17" target="_blank" rel="noopener noreferrer">ZergPool</a></Link></div>
